...
#
# docker build -f src/main/docker/Dockerfile.jvm -t quarkus/labseq-jvm .
#
# Then run the container using:
#
# docker run -i --rm -p 8080:8080 quarkus/labseq-jvm
#
...
# Copiar arquivos Gradle e código-fonte para o contêiner
COPY --chown=185 ./labseq-backend .

# Executar a tarefa de build
RUN ./gradlew build
